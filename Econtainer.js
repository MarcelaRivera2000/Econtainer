...
let botonBolsa = document.getElementById('btn-bolsa');
...
$(document).ready(function () {
  $(window).scroll(function () {
    //para saber cuando el usuario usa el scroll
    if ($(this).scrollTop() > 0) {
...
function agregarBolsa() {
  console.log('nepe');
  cantidadBolsas++;
  document.getElementById('cantidad-bolsa').innerHTML = cantidadBolsas + "";
}
